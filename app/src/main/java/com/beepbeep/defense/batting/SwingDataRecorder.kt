...
internal fun SwingTestActivity.finishTraining() {
    ...
    batch.commit()
        .addOnSuccessListener {
            ...
            com.beepbeep.defense.StatsUpdater.updateBattingStats(
                userId, rankingPitchCount, rankingHitCount, foulCount, strikeCount, successCount,
                rankingReactionTimes, recordsSnapshot, sessionMillis
            )
        }
    ...
    if (actualPitches > 0) {
        ...
        batch.commit()
            .addOnSuccessListener {
                ...
                com.beepbeep.defense.StatsUpdater.updateBattingStats(
                    userId, actualPitches, rankingHitCount, foulCount, strikeCount, successCount,
                    rankingReactionTimes, recordsSnapshot, sessionMillis
                )
            }
            .addOnFailureListener { e ->
